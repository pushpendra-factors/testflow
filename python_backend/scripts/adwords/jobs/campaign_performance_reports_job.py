...
class CampaignPerformanceReportsJob(ReportsFetch):
    FIELDS = ['advertising_channel_sub_type', 'average_position', 'average_time_on_site', 'base_campaign_id', #'budget_id',
                    'campaign_name', 'campaign_status',
            'campaign_trial_type', 'start_date', 'end_date', 'interaction_types', 'is_budget_explicitly_shared', 'url_custom_parameters', 'labels']
    ...
    METRICS = ['active_view_impressions', 'active_view_measurability', 'active_view_measurable_cost',
            ...
            'all_conversion_value', 'all_conversions', 'amount', 'average_cost', 'bounce_rate', 'click_assisted_conversion_value',
