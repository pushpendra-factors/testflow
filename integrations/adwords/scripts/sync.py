...
def get_ad_group_performance_report(adwords_client, timestamp):
    ...
    'average_page_views', 'average_time_on_site', 'ad_group_id', 'ad_group_name', 'ad_group_status'
    'base_ad_group_id','base_campaign_id', 'bounce_rate', 'campaign_id', 'campaign_name', 'campaign_status',
    ...
    'video_quartile_50_rate', 'video_quartile_75_rate', 'video_view_rate', 'video_views', 'view_through_conversions','click_type',
    'final_url_suffix', 'device']
    fields = snake_to_pascal_case(query_fields)
