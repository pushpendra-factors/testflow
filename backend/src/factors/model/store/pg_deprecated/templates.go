...
func (pg *Postgres) GetTemplateConfig(projectID uint64, templateType int) (model.TemplateConfig, int) {
...
func (pg *Postgres) getTemplateThresholds(projectID uint64, templateType int) ([]model.TemplateThreshold, error) {
