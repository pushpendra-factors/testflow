...
func isExistRelationshipByID(projectID uint64, source model.CRMSource, fromType,
	...
	if projectID == 0 || fromType <= 0 || toType <= 0 || fromID == "" || toID == "" {
...
func (pg *Postgres) CreateCRMRelationship(crmRelationship *model.CRMRelationship) (int, error) {
	logFields := log.Fields{
