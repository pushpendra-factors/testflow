...
func createProjectBillingAccountMapping(projectID, billingAccID uint64) (*model.ProjectBillingAccountMapping, int) {
...
func (store *MemSQL) GetProjectBillingAccountMappings(billingAccountID uint64) ([]model.ProjectBillingAccountMapping, int) {
