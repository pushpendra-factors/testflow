...
func mergeAddTypeUserProperties(mergedProperties *map[string]interface{}, userPropertiesRecords []*model.UserProperties) {
...
func (store *MemSQL) UpdateUserPropertiesForSession(projectID uint64,
	...
	errCode := store.updateLatestUserPropertiesForSessionIfNotUpdated(projectID,
...
func (store *MemSQL) updateLatestUserPropertiesForSessionIfNotUpdated(projectID uint64,
