...
type Model interface {
	...
	CacheDashboardUnitsForProjectID(projectID uint64, dashboardUnitIDs []model.DashboardUnit, queryClasses []string, numRoutines int, reportCollector *sync.Map) int
