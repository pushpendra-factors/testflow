...
type Model interface {
	...
	GetAllUserScoreOnDay(project_id int64, ts string, debug bool) ([]model.AllUsersScore, error)
	GetAllUserScoreLatest(project_id int64, debug bool) ([]model.AllUsersScore, error)
