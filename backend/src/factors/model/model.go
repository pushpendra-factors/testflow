...
type Model interface {
	...
	PullEventRowsV2(projectID int64, startTime, endTime int64, sortOnTimestamp bool, minTimestamp int64) (*sql.Rows, *sql.Tx, error)
	...
	GetSalesforceDocumentsByTypeForSync(projectID int64, typ int, skipAction model.SalesforceAction, from, to int64, limit int, offset int) ([]model.SalesforceDocument, int)
	...
	GetIntegrationStatusesCount(settings model.ProjectSetting, projectID int64, agentUUID string) (map[string]interface{}, map[string]interface{})
	...
	GetUserActivities(projectID int64, userId string, isAnonymous bool) ([]model.UserActivity, error)
	GetProfileAccountDetailsByID(projectID int64, domainID string) (*model.AccountDetails, int, string)
	...
	GetIntentTimeline(projectID int64, id string) (model.UserTimeline, error)
