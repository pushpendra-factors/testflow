...
var MapOfMetricsToData = map[string]map[string]map[string]string{
	...
	FacebookDisplayCategory: {
		...
		"fb_pixel_purchase_count":                {"display_name": "Offsite Purchase (Count)"},
		"fb_pixel_purchase_revenue":              {"display_name": "Offsite Purchase (Revenue)"},
		"fb_pixel_purchase_cost_per_action_type": {"display_name": "Cost Per Offsite Purchase"},
		"fb_pixel_purchase_roas":                 {"display_name": "Offsite Purchase (ROAS)"},
	},
