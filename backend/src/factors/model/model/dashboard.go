...
func SetCacheResultByDashboardIdAndUnitId(result interface{}, projectId int64, dashboardId int64, unitId int64, from, to int64, timezoneString U.TimeZoneString) {
