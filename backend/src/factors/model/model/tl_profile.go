...
var HOVER_EVENTS_NAME_PROPERTY_MAP = map[string][]string{
	...
	U.EVENT_NAME_HUBSPOT_ENGAGEMENT_EMAIL: {
		...
		U.EP_HUBSPOT_ENGAGEMENT_SOURCE,
	...
	U.EVENT_NAME_HUBSPOT_CONTACT_FORM_SUBMISSION: {
		...
		U.EP_HUBSPOT_FORM_SUBMISSION_FORMTYPE,
	...
	U.EVENT_NAME_SALESFORCE_TASK_CREATED: {
		...
		U.EP_SF_TASK_COMPLETED_DATETIME,
	},
	...
	U.EVENT_NAME_SALESFORCE_EVENT_CREATED: {
		...
		U.EP_SF_EVENT_COMPLETED_DATETIME,
	},
...
var PAGEVIEW_EVENTPROPS = []string{
	U.EP_PAGE_URL,
	U.EP_REFERRER_URL,
	U.EP_IS_PAGE_VIEW,
