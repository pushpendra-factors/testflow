...
var IntegrationNameList = []string{FEATURE_FACEBOOK, FEATURE_LINKEDIN, FEATURE_GOOGLE_ADS, FEATURE_GOOGLE_ORGANIC, FEATURE_G2, FEATURE_SEGMENT, FEATURE_BING_ADS, FEATURE_RUDDERSTACK, SDK, FEATURE_HUBSPOT, FEATURE_SALESFORCE, FEATURE_LEADSQUARED, FEATURE_MARKETO}
var IntegrationCheckFrequency = map[string]int64{
	...
	FEATURE_GOOGLE_ADS:     12 * U.SECONDS_IN_A_HOUR,
...
const (
	...
	CONNECTED                 = "connected"
	RUSDDERSTACK_PULL_DELAYED = "rudder_stack_delayed"
	SDK_PULL_DELAYED          = "sdk_stack_delayed"
	SEGMENT_PULL_DELAYED      = "segment_stack_delayed"
)
