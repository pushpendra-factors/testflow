...
var EP_SESSION_TIME_SPENT string = "$session_time_spent"
...
var UP_LATEST_REFERRER = "$latest_referrer"
var UP_LATEST_REFERRER_URL = "$latest_referrer_url"
var UP_LATEST_REFERRER_DOMAIN = "$latest_referrer_domain"
