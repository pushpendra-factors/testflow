...
// WHITELIST_FACTORS_EVENT_PROPERTIES EVENT properties enabled for the factors analysis.
var WHITELIST_FACTORS_EVENT_PROPERTIES = [...]string{
	...
	EP_ADGROUP,
	SP_INITIAL_REFERRER,
	SP_INITIAL_REFERRER_DOMAIN,
}

// WHITELIST_FACTORS_REPEATED_EVENTS repeated events that are allowed for factors analysis.
var WHITELIST_FACTORS_REPEATED_EVENTS = [...]string{
	EVENT_NAME_HUBSPOT_CONTACT_CREATED,
	EVENT_NAME_HUBSPOT_CONTACT_UPDATED,
}
