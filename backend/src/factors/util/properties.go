...
var EP_HUBSPOT_ENGAGEMENT_DISPOSITION_LABEL string = "$hubspot_engagement_disposition_label"
var EP_SALESFORCE_CAMPAIGN_TYPE string = "$salesforce_campaign_type"
var EP_SALESFORCE_CAMPAIGN_STATUS string = "$salesforce_campaign_status"
...
var ENRICHED_SALESFORCE_ACCOUNT_OBJECT_URL = "$salesforce_account_$object_url"
var ENRICHED_HUBSPOT_COMPANY_OBJECT_URL = "$hubspot_company_$object_url"
...
var STANDARD_EVENTS_DISPLAY_NAMES = map[string]string{
	...
	EVENT_NAME_SALESFORCE_TASK_UPDATED:   "Salesforce Task Updated",
	EVENT_NAME_SALESFORCE_EVENT_CREATED:  "Salesforce Event Created",
	EVENT_NAME_SALESFORCE_EVENT_UPDATED:  "Salesforce Event Updated",
...
var ALL_ACCOUNTS_TOTAL_PROPERTIES = []string{
	...
	DP_INITIAL_TERM,
	DP_INITIAL_CHANNEL,
	DP_INITIAL_PAGE_SPENT_TIME,
	DP_INITIAL_PAGE_SCROLL_PERCENT,
	DP_INITIAL_KEYWORD,
	DP_LATEST_PAGE_URL,
	DP_LATEST_REFERRER_DOMAIN,
	DP_LATEST_MEDIUM,
	DP_LATEST_SOURCE,
	DP_LATEST_CAMPAIGN,
	DP_LATEST_CONTENT,
	DP_LATEST_TERM,
	DP_LATEST_CHANNEL,
	DP_LATEST_PAGE_SPENT_TIME,
	DP_LATEST_PAGE_SCROLL_PERCENT,
	DP_LATEST_KEYWORD,
	DP_TOTAL_PAGE_COUNT,
	DP_TOTAL_PAGE_SPENT_TIME,
}

var ENGAGEMENT_PROPERTIES = []string{
	DP_ENGAGEMENT_LEVEL,
	DP_ENGAGEMENT_SCORE,
	DP_TOTAL_ENGAGEMENT_SCORE,
	DP_ENGAGEMENT_SIGNALS,
