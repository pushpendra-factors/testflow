...
var STANDARD_EVENT_PROPERTIES_DISPLAY_NAMES = map[string]string{
	"$is_page_view":           "Is Page View",
	"$page_title":             "Page Title",
	"$page_domain":            "Page Domain",
	"$page_raw_url":           "Page Raw URL",
	"$page_url":               "Page URL",
	"$referrer":               "Referrer",
	"$referrer_domain":        "Referrer Domain",
	"$referrer_url":           "Referrer URL",
	"$page_load_time":         "Page Load Time",
	"$page_spent_time":        "Page Spent Time",
	"$page_scroll_percent":    "Page Scroll Percent",
	"$segment_event_version":  "Segment Event Version",
	"$segment_source_library": "Segment Source Library",
	"$segment_source_channel": "Segment Source Channel",
	"$campaign":               "Campaign",
...
var STANDARD_SESSION_PROPERTIES_DISPLAY_NAMES = map[string]string{
	...
	"$session_spent_time":          "Session Time Spent",
	"$page_count":                  "Page Count",
	"$session_latest_page_url":     "Session Exit Page URL",
	"$session_latest_page_raw_url": "Session Exit Page Raw URL",
	"$initial_page_url":            "Landing Page URL",
...
var CUSTOM_BLACKLIST_DELTA = []string{"$initial_page_domain",
	"$session_count",
	"$initial_page_url",
	"$page_title",
	"$browser_version",
