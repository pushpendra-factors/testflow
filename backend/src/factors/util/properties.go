...
var STANDARD_EVENT_PROPERTIES_DISPLAY_NAMES = map[string]string{
	...
	EP_MEDIUM:                 "Medium",
	EP_KEYWORD:                "Keyword",
	EP_KEYWORD_MATCH_TYPE:     "Keyword Match Type",
	EP_CONTENT:                "Content",
	EP_ADGROUP:                "Adgroup",
...
var STANDARD_USER_PROPERTIES_DISPLAY_NAMES = map[string]string{
	...
	UP_INITIAL_KEYWORD_MATCH_TYPE:       "Initial Keyword Match Type",
	...
	UP_LATEST_KEYWORD_MATCH_TYPE:        "Latest Keyword Match Type",
