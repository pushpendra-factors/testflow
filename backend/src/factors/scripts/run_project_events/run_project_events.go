...
func main() {
	...
	projectId := flag.Int("projectId", 0, "Project Id of events")
	...
	fileDir, fileName := (cloudManager).GetModelEventsFilePathAndName(uint64(*projectId), startTimeStamp, *modelType)
