...
(
    ...
    "entity" integer NOT NULL, -- There are 4 types Event/EventProperty/UserProperty/Object Property(hubspot/salesforce)
...
CREATE UNIQUE INDEX display_names_project_id_object_group_entity_tag_unique_idx on display_names(project_id, "entity", "group", group_object_name, display_name);
