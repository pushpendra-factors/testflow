...
func InitAppRoutes(r *gin.Engine) {
	...
	r.GET(routePrefix+"/projectanalytics", V1.GetFactorsAnalyticsHandler)
	r.GET(routePrefix+"/:project_id/projectanalytics", V1.GetFactorsAnalyticsByprojectIDHandler)
