...
var webEventProps = []string{U.EP_PAGE_RAW_URL, U.EP_PAGE_DOMAIN, U.EP_PAGE_URL, U.EP_PAGE_TITLE,
	U.EP_REFERRER, U.EP_REFERRER_DOMAIN, U.EP_REFERRER_URL, U.EP_CAMPAIGN, U.EP_SOURCE, U.EP_MEDIUM, U.EP_KEYWORD, U.EP_CONTENT}

// expected user properties from segment.
var genericUserProps = []string{U.UP_PLATFORM, U.UP_SEGMENT_CHANNEL, U.UP_USER_AGENT, U.UP_COUNTRY, U.UP_CITY, U.UP_OS, U.UP_OS_VERSION,
