...
func TestTaskExecutionInsert(t *testing.T) {
	...
	assert.Equal(t, deltas[1], uint64(2021032300))
	assert.Equal(t, deltas[8], uint64(2021040100))
	assert.Equal(t, deltas[9], uint64(2021040400))
	assert.Equal(t, len(deltas), 10)
	...
	deltas, _, _ = store.GetStore().GetAllDeltasByConfiguration(id, 30, &endDate)
	assert.Equal(t, deltas[0], uint64(2021022102))
	assert.Equal(t, deltas[3], uint64(2021031402))
	assert.Equal(t, deltas[4], uint64(2021032102))
	assert.Equal(t, deltas[5], uint64(2021032802))
}
...
func TestTaskDependencyInsertDelete(t *testing.T) {
	...
	deltas, _, _ = store.GetStore().GetAllToBeExecutedDeltas(id3, 0, 2, nil)
...
func TestIsDependentTaskDone(t *testing.T) {
	...
	assert.Equal(t, isDone, false)
	deltaTime := getDeltaAsTime(uint64(2021041900))
	...
	isDone = store.GetStore().IsDependentTaskDone(id10, 0, 2021042500)
	assert.Equal(t, isDone, true)
	store.GetStore().DeleteTaskEndRecord(id9, 0, 2021041900)
	isDone = store.GetStore().IsDependentTaskDone(id10, 0, 2021042500)
	assert.Equal(t, isDone, false)
	store.GetStore().InsertTaskBeginRecord(id9, 0, 2021041900)
	store.GetStore().InsertTaskEndRecord(id9, 0, 2021041900)
	store.GetStore().DeleteTaskEndRecord(id9, 0, 2021042523)
	isDone = store.GetStore().IsDependentTaskDone(id10, 0, 2021042500)
	assert.Equal(t, isDone, false)
	store.GetStore().InsertTaskBeginRecord(id9, 0, 2021042523)
	store.GetStore().InsertTaskEndRecord(id9, 0, 2021042523)
	store.GetStore().DeleteTaskEndRecord(id9, 0, 2021042423)
	isDone = store.GetStore().IsDependentTaskDone(id10, 0, 2021042500)
	assert.Equal(t, isDone, false)
	...
	isDone = store.GetStore().IsDependentTaskDone(id10, 0, 2021042500)
	assert.Equal(t, isDone, false)
	deltaTime = getDeltaAsTime(uint64(2021041200))
	for i := uint64(0); i <= uint64(24*7)-1; i++ {
		store.GetStore().InsertTaskBeginRecord(id9, 0, U.DateAsFormattedInt(deltaTime.Add(time.Hour*time.Duration(i))))
		store.GetStore().InsertTaskEndRecord(id9, 0, U.DateAsFormattedInt(deltaTime.Add(time.Hour*time.Duration(i))))
	}
	...
	isDone = store.GetStore().IsDependentTaskDone(id12, 0, 2021042500)
	assert.Equal(t, isDone, true)
	store.GetStore().DeleteTaskEndRecord(id11, 0, 2021041900)
	isDone = store.GetStore().IsDependentTaskDone(id12, 0, 2021042500)
	assert.Equal(t, isDone, false)
	store.GetStore().InsertTaskBeginRecord(id11, 0, 2021041900)
	store.GetStore().InsertTaskEndRecord(id11, 0, 2021041900)
	...
	store.GetStore().DeleteTaskEndRecord(id11, 0, 2021042400)
	isDone = store.GetStore().IsDependentTaskDone(id12, 0, 2021042500)
	assert.Equal(t, isDone, false)
