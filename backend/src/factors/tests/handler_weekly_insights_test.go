...
func TestWeeklyInsights(t *testing.T) {
	...
	assert.Equal(t,outputObj.Base.W1,float64(100))
	assert.Equal(t,outputObj.Base.W2,float64(150))
	assert.Equal(t,outputObj.Base.IsIncreased,true)
	assert.Equal(t,outputObj.Base.Percentage,float64(50))
	assert.Equal(t,outputObj.Goal.W1,float64(123))
	assert.Equal(t,outputObj.Goal.W2,float64(246))
	assert.Equal(t,outputObj.Goal.IsIncreased,true)
	assert.Equal(t,outputObj.Goal.Percentage,float64(100))
	assert.Equal(t,outputObj.Conv.W1,float64(1))
	assert.Equal(t,outputObj.Conv.W2,float64(2))
	...
	assert.Equal(t,outputObj.Insights[0].ActualValues.W1,float64(1))
	assert.Equal(t,outputObj.Insights[0].ActualValues.W2,float64(2))
	...
	assert.Equal(t,outputObj.Insights[0].ChangeInConversion.W1,float64(1))
	assert.Equal(t,outputObj.Insights[0].ChangeInConversion.W2,float64(2))
	...
	assert.Equal(t,outputObj.Insights[0].ChangeInPrevalance.W1,float64(1))
	assert.Equal(t,outputObj.Insights[0].ChangeInPrevalance.W2,float64(1))
	...
	assert.Equal(t,outputObj.Insights[1].ActualValues.W1,float64(1))
	assert.Equal(t,outputObj.Insights[1].ActualValues.W2,float64(2))
