...
const DashboardBeforeIntegration = ({
  currentAgent,
  setActiveProject,
  fetchDemoProject,
  projects
        ...
        <Row justify={'center'} className={'mt-4'}>
          <Col span={15}>
            ...
            <Text
              ...
              color={'grey'}
            >
              All your important metrics at a glance. The dashboard is where you
              save your analyses for quick and easy viewing. Create multiple
              dashboards for different needs, and toggle through them as you
              wish. Making the right decisions just became easier.{' '}
              <a
                href='https://help.factors.ai/en/articles/6294988-dashboards'
                target={'_blank'}
              >
                Learn more
              </a>
            ...
            <Text
              ...
              color={'grey'}
            >
              Finish connecting to your data sources - it's time to build your
              first dashboard!
            </Text>
          </Col>
        </Row>
