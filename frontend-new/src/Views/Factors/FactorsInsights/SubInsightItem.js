                                     ...
                                     <div className={'relative flex items-end'}>
                                         ...
                                         <div className={'flex-grow'}> 
                                          <div className={'flex items-end'}>
                                            ...
                                            <div className={'flex items-center fa-insights-box--animate'}><Text type={'title'} weight={'thin'} level={7} extraClass={'m-0 ml-1'} >{_.isEmpty(ParentData.goal?.st_en) ? 'All Visitors' : ParentData.goal?.st_en } </Text></div>
                                          </div>
                                          <Progress strokeWidth={10} percent={100} strokeColor={ProgressColor.blue} className={'fa-custom-stroke-bg fa-custom-progress-value'} showInfo={false} value={numberWithCommas(ParentData.total_users_count)} />
                                        </div>
                                      </div>
                                    </>
                                  } 
                                  ...
                                  <div className={'relative flex items-end'}>
                                         ...
                                         <div className={'flex-grow'}> 
                                          <div className={'flex items-end'}>
                                            ...
                                            <div className={'flex items-center fa-insights-box--animate'}> <Text type={'title'} weight={'thin'} level={7} extraClass={'m-0 ml-1'} >{insightKeyLevel1}</Text></div>
                                          </div>
                                          <Progress strokeWidth={10} percent={insightLevel1Percentage} strokeColor={ProgressColor.blue} className={'fa-custom-stroke-bg fa-custom-progress-value'} showInfo={false} value={numberWithCommas(SubInsightsData.factors_insights_users_count)} />
                                          </div>
                                    </div>
                                    ...
                                    <div className={'relative flex items-end'}>
                                         ...
                                         <div className={'flex-grow'}> 
                                            <div className={'flex items-end'}>
                                              ...
                                              <div className={'flex items-center fa-insights-box--animate'}> <Text type={'title'} weight={'thin'} level={7} extraClass={'m-0 ml-1'} >{insightKeyLevel2}</Text></div>
                                            </div>
                                            <Progress strokeWidth={10} percent={insightLevel2Percentage} strokeColor={ProgressColor.blue} className={'fa-custom-stroke-bg fa-custom-progress-value'} showInfo={false} value={numberWithCommas(dataItem.factors_insights_users_count)} />
                                          </div>
                                    </div>
                                  ...
                                  <div className={'relative border-left--thin-2 m-0 pl-10 py-6 fa-insight-item'}>
                                      ...
                                      <div className={'relative flex items-end'}>
                                         ...
                                         <div className={'flex-grow'}>  
                                            ...
                                            <Progress strokeWidth={10} percent={100} strokeColor={ProgressColor.blue} className={'fa-custom-stroke-bg fa-custom-progress-value'} showInfo={false} value={numberWithCommas(SubLevel1Data.factors_insights_users_count)} />
                                          </div>
                                    </div>
                                    ...
                                    <div className={'relative flex items-end'}>
                                         ...
                                         <div className={'flex-grow'}>  
                                            <div className={'flex items-end'}>
                                              ...
                                              <div className={'flex items-center ml-4 fa-insights-box--animate'}>   <Text type={'title'} weight={'thin'} level={7} extraClass={'m-0 ml-1'} >{insightKeyLevel2}</Text></div>
                                            </div>
                                            <Progress strokeWidth={10} percent={insightLevel2Percentage} strokeColor={ProgressColor.blue} className={'fa-custom-stroke-bg fa-custom-progress-value'} showInfo={false} value={numberWithCommas(SubLevel2Data.factors_insights_users_count)} />
                                        </div>
                                    </div>
                                    ...
                                    <div className={'relative flex items-end'}>
                                         ...
                                         <div className={'flex-grow'}>   
                                            <div className={'flex items-end'}>
                                              {/* <div className={'flex items-center ml-4 fa-insights-box--fixed-count'}><a><Text type={'title'} weight={'regular'} level={7} extraClass={'m-0 tracking-wider'} >{numberWithCommas(dataItem.factors_insights_users_count)}</Text></a> </div> */}
                                              <div className={'flex items-center fa-insights-box--animate'}>   <Text type={'title'} weight={'thin'} level={7} extraClass={'m-0 ml-1'} >{insightKeyLevel3}</Text></div>
                                            </div>
                                            <Progress strokeWidth={10} percent={insightLevel3Percentage} strokeColor={ProgressColor.blue} className={'fa-custom-stroke-bg fa-custom-progress-value'} showInfo={false} value={numberWithCommas(dataItem.factors_insights_users_count)} />
                                          </div>
                                    </div>
