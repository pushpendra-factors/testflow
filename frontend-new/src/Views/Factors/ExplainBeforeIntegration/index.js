...
const ExpalinBeforeIntegration = ({
  currentAgent,
  setActiveProject,
  fetchDemoProject,
  projects
        ...
        <Row justify={'center'} className={'mt-8'}>
          <Col span={15}>
            ...
            <Text
              ...
              color={'grey'}
            >
              Find yourself asking how you can improve conversions between any
              two milestones of a user journey? The Explain module helps you
            ...
            <Text
              ...
              level={6}
              weight={'regular'}
              extraClass={'m-0 w-11/12 mt-2'}
              color={'grey'}
            >
              To access this, please complete your setup by connecting to your
              data sources.
            </Text>
          </Col>
        </Row>
