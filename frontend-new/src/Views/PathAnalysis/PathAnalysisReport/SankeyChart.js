...
const StepArraowGenerator = (activeQuery) => {
  ...
  return (
    <div
      className={`custom-table-headers--sankey ${isReverse ? 'reverse' : ''}`}
    >
  ...
  const options = {
          ...
          nodeFormatter() {
            ...
            return ReactDOMServer.renderToString(
              ...
              >
                ...
                <h1 style={{ fontSize: '8px', margin: '0px' }}>{value}</h1>
              </div>
            );
          }
        },
    ...
    tooltip: {
      ...
      formatter() {
        ...
        return ReactDOMServer.renderToString(<CustomTooltip data={self} />);
      }
    },
    credits: {
      enabled: false
    ...
    series: [
      {
        type: 'sankey',
        keys: reverseChart
          ? ['to', 'from', 'weight', 'percentage']
          : ['from', 'to', 'weight', 'percentage'],
        // keys: ['from', 'to', 'weight'],
