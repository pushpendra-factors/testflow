...
function EditUserDetails(props) {
  ...
  const inputComponentRef = useAutoFocus(props.visible);
  ...
  const onFinish = (values) => {
    ...
    props
      .updateAgentInfo(sanitizedValues)
      .then(() => {
...
export default connect(mapStateToProps, { updateAgentInfo, fetchAgentInfo })(
  EditUserDetails
);
