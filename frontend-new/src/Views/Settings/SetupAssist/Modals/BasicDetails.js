...
function BasicDetails({
  ...
  const inputComponentRef = useAutoFocus(!formData);
  ...
  const onFinish = (values) => {
    ...
    createProjectWithTimeZone(projectData)
      .then((res) => {
        const projectId = res.data.id;
        if (checkbox) {
          projectAgentInvite(projectId, {
            email: 'solutions@factors.ai',
            role: 2
          })
            .then(() => {
        ...
        if (imageUrl) {
          udpateProjectDetails(projectId, { profile_picture: imageUrl })
            .then(() => {
  ...
  return (
    <>
                    ...
                    >
                      <Row>
                        ...
                        <Col span={24} className={'mt-4'}>
                          ...
                          >
                            This must reflect the same timezone as in your CRM
                          </Text>
                          <Popconfirm
                            placement='rightTop'
                            title={
                              <Text
                                ...
                                extraClass={'max-w-xs'}
                              >
                                This must reflect the same timezone as used in
                                your CRM. Once selected, this action cannot be
                                edited.
                              </Text>
                            }
                            icon={
                        ...
                        {showProfile ? (
                          <Col span={24}>
                            <Row
                              className={
                                'animate__animated animate__fadeIn mt-4 border-t'
                              }
                            >
                              <Col span={6} className={'mt-6'}>
                                ...
                                >
                                  {imageUrl ? (
                                    ...
                                    <img src='../../../../assets/avatar/upload-picture.png'></img>
                                  )}
                                </Upload>
                              </Col>
                              <Col span={17} className={'mt-6'}>
                                ...
                                <Text
                                  ...
                                  color={'grey'}
                                >
                                  You can skip this now and do it later by going
      ...
      {formData && (
        <Congrates handleCancel={handleCancel} handleReset={handleReset} />
      )}
    </>
  );
}
