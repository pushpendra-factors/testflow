        ...
        <>
            <div className={'m-0'}>
                <Row justify={'center'} className={'mt-24'}>
                    <Col span={16}>
                        <Text type={'title'} level={2} weight={'bold'} extraClass={'m-0'}>Hey! Welcome {currentAgent.first_name}</Text>
                        <Text type={'title'} level={6} weight={'regular'} extraClass={'m-0'} color={'grey'}>With Factors, you will always know which marketing activites drive conversions.</Text>
                        <Text type={'title'} level={6} weight={'regular'} extraClass={'m-0'} color={'grey'}>Use this information to scale channels that bring you success.</Text>
                        <Text type={'title'} level={6} weight={'regular'} extraClass={'m-0 mt-2'} color={'grey'}>The first step to get up and running with Factors is to get data into your project:</Text>
                    </Col>
                </Row>
                    ...
                    <Col span={16}>
                        <Row className={'justify-between'}>
                            <div className={`${styles.first}`}>
                                <Row>
                                    <Col span={18}>
                                        <Text type={'title'} level={5} weight={'bold'} extraClass={'m-0 ml-6 mt-4'}>Connect to data sources</Text>
                                        <Text type={'title'} level={6} weight={'regular'} extraClass={'m-0 ml-6 mb-6'} color={'grey'}>Approximated time ~15 minutes</Text>
                            ...
                            <div className={`${styles.first}`}>
                                <Row>
                                    <Col span={20}>
                                        <Text type={'title'} level={5} weight={'bold'} extraClass={'m-0 ml-6 mt-4'}>See how Factors works</Text>
                                        <Text type={'title'} level={6} weight={'regular'} extraClass={'m-0 ml-6 mb-2'} color={'grey'}>Quickly learn about features, configuration, and more</Text>
                    ...
                    <Col span={16} className={`${styles.second} mt-4`}>
                        <Row>
                            <Col span={14}>
                                ...
                                <Text type={'title'} level={7} color={'white'} extraClass={'m-0 ml-6 mb-4'} style={{opacity: 0.7}}>To get the most out of the trial period with Factors, get a personalized demo with our in-house product experts</Text>
