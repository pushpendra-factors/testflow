                    ...
                    <Row>
                        <Col span={12}>
                            <Text type={'title'} level={3} weight={'bold'} extraClass={'m-0'}>{
                                formState ==='add'?  
                                'New Default Channel Group' : 'Default Channel Group Details'
                                }
                            </Text>
                        </Col>
                        <Col span={12}>
                            <div className={'flex justify-end'}>
                                <Button size={'large'} disabled={false} onClick={() => setShowDCGForm(false)}>Cancel</Button>
                                {
                                    formState === 'view' ? 
