...
const Slack = ({
  ...
  useEffect(() => {
    if (slack_users) {
      const slackUserList = slack_users
  ...
  return (
    <div
      ...
      style={{ borderColor: ErrorMsg ? 'red' : 'auto' }}
    >
      <div
        style={{
            ...
            <div className='flex justify-between p-3'>
              ...
              <div className='flex flex-col justify-start items-start ml-2 w-full'>
                <div className='flex flex-row items-center justify-start'>
                  <Text type='title' level={7} weight='medium' extraClass='m-0'>
                    Slack
                  </Text>
                  {ErrorMsg && (
                ...
                <Text
                  ...
                  lineHeight='medium'
                >
                  Get your alerts inside your Slack channel. You can also choose
                  to send the alert to multiple channels.
                </Text>
              </div>
            </div>
          </Col>
      ...
      <div>
                ...
                <Col className='pr-4'>
                  ...
                  <div className='flex items-center mt-4'>
                    ...
                    <Button
                      type='link'
                      loading={loading}
                      onClick={() => refreshSlackDetails()}
                      icon={<SVG name='ArrowRotateRight' size={16} />}
                      className='fa-button-ghost ml-2'
                    >
                      Refresh to check
                    </Button>
                  </div>
                    ...
                    {slackUsers?.length > 0 ? (
                      <div className='mt-6'>
                        ...
                        <div className='mt-2 flex' style={{ width: '375px' }}>
                          ...
                          <Text
                            ...
                            extraClass='m-0 ml-1'
                          >
                            The mentioned user will be tagged in all alerts that
                            are sent with these settings.
                          </Text>
                        </div>
                      </div>
                    ) : (
                      <div className='mt-6'>
                        <Text
                          ...
                          extraClass='m-0 mt-2'
                        >
                          Your current Slack integration doesn’t have mentions.
                          Simply reintegrate Slack with Factors to mention users
                          in alerts.
                        </Text>
                        <Button
                          className='mt-2'
        ...
        {slackEnabled && projectSettings?.int_slack && (
          <div className='border-top--thin-2 mt-4 p-4'>
            <Button
              disabled={!saveSelectedChannel.length > 0}
              loading={slackTestMsgLoading}
              icon={
                slackTestMsgTxt ? (
                  <SVG name='Checkmark' size={16} color='grey' />
                ) : (
                  <SVG name='PaperPlane' size={16} color='grey' />
                )
              }
