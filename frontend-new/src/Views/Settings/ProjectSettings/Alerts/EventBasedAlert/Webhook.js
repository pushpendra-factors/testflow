...
import PreviewCard, { PreviewCardWebhook } from './PreviewCard';
            ...
            <div className='flex justify-between p-3'>
              ...
              <div className='flex flex-col justify-start items-start ml-2 w-full'>
                ...
                <Text
                  ...
                  lineHeight='medium'
                >
                  Create a webhook with this event trigger and send the selected
                  properties to other tools for automation.
                </Text>
                {/* <Text
                        type='paragraph'
                        mini
                ...
                <div className='flex flex-end items-center'>
                  ...
                  <span style={{ width: '50px' }}>
                    <Switch
                      ...
                      disabled={isWebHookFeatureLocked}
            ...
            <Col span={12} className='m-0'>
                    ...
                    {testMessageResponse ? (
                      <div>
                        <div className='inline'>
                          ...
                          >
                            We've sent a sample message to this endpoint. Check
                            and hit 'Confirm' if everything is alright!
                          </Text>
                        </div>
                        <div className='inline'>
                          <Button
              ...
              <Row className='mt-3'>
                ...
                <Col>
                  <div className='mt-6'>
                    <Checkbox
                      checked={factorsURLinWebhook}
                      onChange={(e) => setFactorsURLinWebhook(e.target.checked)}
                    >
                      Send Factors Activity URL in webhook payload
                    </Checkbox>
                  </div>
                </Col>
              </Row>
