...
const RevealIntegration = ({
  ...
  return (
    <>
      <ErrorBoundary fallback={<FaErrorComp subtitle={'Facing issues with Clearbit integrations'} />} onError={FaErrorLog}>
        ...
        >
          <div className={'p-4'}>
            ...
            >
              ...
              <Row>
                <Col span={24}>
                  <Text type={'title'} level={6} weight={'bold'} extraClass={'m-0 mt-2'}>Integrate with Clearbit Reveal</Text>
                  <Text type={'title'} level={7} color={'grey'} extraClass={'m-0 mt-2'}>Add your Backend API key (i.e, Clearbit Secret Key) to connect with your Clearbit account.</Text>
                </Col>
              </Row>
              <Row className={'mt-6'}>
                <Col span={24}>
                  ...
                  >
                    <Input size="large" className={'fa-input w-full'} placeholder="Clearbit API Key" />
                  </Form.Item>
                </Col>
        ...
        {
          currentProjectSettings?.int_clear_bit && <div className={'mt-4 flex flex-col border-top--thin py-4 mt-2 w-full'}>
            ...
            <Input size="large" disabled={true} placeholder="API Key" value={currentProjectSettings.clearbit_key} style={{ width: '400px' }} />
          </div>
        }
...
export default connect(mapStateToProps, { fetchProjectSettings, udpateProjectSettings })(RevealIntegration);