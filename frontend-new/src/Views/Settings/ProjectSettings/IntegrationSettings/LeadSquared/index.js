  ...
  return (
    <>
      <ErrorBoundary
        fallback={
          <FaErrorComp
            subtitle={'Facing issues with LeadSquared integrations'}
          />
        }
        onError={FaErrorLog}
      >
              ...
              <Row>
                <Col span={24}>
                  <Avatar
                    ...
                    shape={'square'}
                    icon={
                      <SVG name={'LeadSquared'} size={40} color={'purple'} />
                    }
              ...
              <Row>
                <Col span={24}>
                  ...
                  <Text
                    ...
                    extraClass={'m-0 mt-2'}
                  >
                    Add your Access key, Secret Key and Host from Leadsquared to
                    connect with your Leadsquared account.
                  </Text>
                </Col>
              </Row>
              <Row className={'mt-6'}>
        ...
        {currentProjectSettings?.lead_squared_config !== null && (
          ...
          >
            ...
            <Input
              ...
              disabled={true}
              placeholder='Access Key'
              value={currentProjectSettings?.lead_squared_config?.access_key}
              style={{ width: '400px' }}
            />
            <Text
              type={'title'}
            ...
            <Input
              ...
              disabled={true}
              placeholder='Secret Key'
              value={currentProjectSettings?.lead_squared_config?.secret_key}
              style={{ width: '400px' }}
            />
            <Text
              type={'title'}
            ...
            <Input
              ...
              disabled={true}
              placeholder='Host'
              value={currentProjectSettings?.lead_squared_config?.host}
              style={{ width: '400px' }}
            />
          </div>
        )}
