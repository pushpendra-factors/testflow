...
const ConfigureDP = (props) => {
  ...
  return ( 
        ...
        <Row className='w-full'  justify={'center'}>
            <Col span={24}>
                <Text type={'title'} level={3} weight={'bold'} extraClass={'m-0'} >Top Events and Properties</Text>
                <Text type={'title'} level={7} color={'grey-2'} extraClass={'m-0 mb-8'}>The events and properties under this list will be considered as the top events and properties of the project and will be tracked freequently. </Text>
            </Col>
        {showInfo && <Col span={24}>
