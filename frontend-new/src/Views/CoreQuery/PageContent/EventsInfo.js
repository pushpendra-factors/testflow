...
function EventsInfo({ queries }) {
    return (
        <div className="my-4 flex items-center pl-4" style={{ lineHeight: '24px' }}>
            <span className="mr-4">
                ...
                if (index < queries.length - 1) {
                    return (
                        <React.Fragment key={q}>
                            <span style={{ color: '#0E2647' }} className="text-xl font-bold">{q}</span>
                            <span style={{ color: '#8692A3' }} className="text-base">&nbsp;and then&nbsp;</span>
                        </React.Fragment>
                    )
                } else {
                    return (
