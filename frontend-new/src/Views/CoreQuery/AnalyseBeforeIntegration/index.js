...
const AnalyseBeforeIntegration = ({currentAgent, setActiveProject, fetchDemoProject, projects}) => {
            ...
            <Row justify={"center"} className={"mt-8"}>
                <Col span={15}>
                    ...
                    <Text type={"title"} level={6} weight={"regular"} extraClass={"m-0 w-11/12"} color={"grey"}>
                        Here's where all the action happens. The Analyse Hub lets you run multiple forms of analyses over your data — from KPI monitoring and funnels, to attribution modelling and AI insights. Use these modules to get a deeper understanding of your marketing and revenue activities.
                    </Text>
                </Col>
            </Row>
...
export default connect(mapStateToProps, { fetchDemoProject, setActiveProject })(AnalyseBeforeIntegration);
