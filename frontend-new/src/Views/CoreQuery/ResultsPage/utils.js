...
export const generateTableColumns = (data, currentSorter, handleSorting) => {
    let result = [
        ...
        {
            title: getTitleWithSorter('Conversion'),
    ...
    let eventColumns = data.map((elem, index) => {
        return {
            title: getTitleWithSorter(elem.name, currentSorter),
            dataIndex: elem.name,
...
const getTitleWithSorter = (title, currentSorter) => {
    return (
        <div className="flex items-center">
            <div className="mr-2">{title}</div>
            <div className="flex flex-col">
                <a href="#" style={{ marginBottom: "1px" }}>
                    <svg width="9" height="6" viewBox="0 0 9 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.35117 1.3516L8.39362 4.36853C8.61554 4.58859 8.45971 4.96706 8.14718 4.96706H5.00002H1.83533C1.52237 4.96706 1.36673 4.58769 1.58953 4.36789L4.64797 1.3507C4.84302 1.15827 5.15661 1.15867 5.35117 1.3516Z" stroke="#8692A3" />
                    </svg>
                ...
                <a href="#" style={{ marginTop: "1px" }}>
                    <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M4.64721 4.65009L1.60105 1.59899C1.38084 1.37842 1.53706 1.0017 1.84874 1.0017L4.99996 1.0017L8.1721 1.00172C8.4843 1.00172 8.64028 1.3795 8.41903 1.59976L5.3538 4.65118C5.1583 4.8458 4.84211 4.84532 4.64721 4.65009Z" stroke="#8692A3" />
                    </svg>
                </a>
            </div>
