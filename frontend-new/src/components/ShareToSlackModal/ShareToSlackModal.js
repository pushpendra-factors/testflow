            ...
            <Row>
              ...
              >
                <Row>
                  ...
                  <div
                    className={
                      'flex flex-col border-top--thin mb-4 mt-2 w-full'
                    }
                  />
                  <Col span={24}>
                  ...
                  <Col span={23}>
                    <Row className={'mb-3'}>
                      <Col span={5}>
                        <Form.Item label={null} name='date_range'>
                          <Select
                            className={'fa-select'}
                  ...
                  <Col span={23}>
                    <div className={'w-full'}>
                      <Text type={'title'} level={7} extraClass={'m-0 mb-1'}>
                        Data is captured up to 2 hours before this email is
                        sent. This is to make sure this email is delivered as
                        on-time as possible
                      </Text>
                    </div>
                  </Col>
                  <div
                    className={'flex flex-col border-top--thin my-4 w-full'}
                  />
                  <Col span={23}>
                    <div className={'w-full mb-3'}>
                      <Text type={'title'} level={7} extraClass={'m-0 mb-1'}>
                        Not getting our messages?{' '}
                        <a href={meetLink(true)} target='_blank'>
                          Let us know
                        </a>
                      </Text>
                    </div>
