...
const ProfileBeforeIntegration = ({
  currentAgent,
  setActiveProject,
  fetchDemoProject,
  projects
        ...
        <Row justify={'center'} className={'mt-8'}>
          <Col span={15}>
            ...
            <Text
              ...
              color={'grey'}
            >
              See every touchpoint of your visitors as they navigate across your
              digital presence. Use this to understand what prompts them to
              convert, so you can double down on where it really matters.
            </Text>
          </Col>
        </Row>
