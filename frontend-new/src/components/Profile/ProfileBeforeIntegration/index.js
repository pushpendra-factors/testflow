...
const ProfileBeforeIntegration = ({currentAgent, setActiveProject, fetchDemoProject, projects}) => {
      ...
      <>
        <div className={"m-0"}>
            <Row justify={"center"} className={'mt-24'}>
                <Col span={15}>
                    <img src='https://s3.amazonaws.com/www.factors.ai/assets/img/product/profiles-img.svg' />
                </Col>
            </Row>
            <Row justify={"center"} className={"mt-8"}>
                <Col span={15}>
                    ...
                    <Text type={"title"} level={6} weight={"regular"} extraClass={"m-0 w-11/12"} color={"grey"}>
                        See every touchpoint of your visitors as they navigate across your digital presence. Use this to understand what prompts them to convert, so you can double down on where it really matters.
                    </Text>
                </Col>
            </Row>
...
export default connect(mapStateToProps, { fetchDemoProject, setActiveProject })(ProfileBeforeIntegration);
