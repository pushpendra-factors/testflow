function applyTopCornerBorderRadius(Highcharts) {
  // For future reference copied this from https://github.com/bellstrand/highcharts-border-radius/blob/master/index.js
  (function (H) {
    H.wrap(H.seriesTypes.column.prototype, 'translate', function (proceed) {
      ...
      function setPoints(point) {
        if (options.borderRadiusTopLeft || options.borderRadiusTopRight) {
          ...
          var radiusBottomRight = H.relativeLength(0, w);
          var radiusBottomLeft = H.relativeLength(0, w);
      ...
      this.points.forEach((point) => setPoints(point));
    });
  })(Highcharts);
}

export default function customizeHighCharts(Highcharts) {
  // enable top left/right border radius
  applyTopCornerBorderRadius(Highcharts);
}
